...
import request from "@/utils/request";
  export default {
    ...
    created() {
      ...
      const avatarFilename = localStorage.getItem('img_url_touxiang');
      if (avatarFilename) {
        this.businessInfo.avatar = this.Host + '/upimg/' + avatarFilename;
      } else {
...
.business-dashboard-wrapper {
    ...
    padding: 40px 0;
    min-height: 100vh;
    background-image: url('/upimg/bg-dashboard.jpg'); 
